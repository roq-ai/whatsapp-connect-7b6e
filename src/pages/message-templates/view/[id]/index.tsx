...
import { getMessageTemplateById } from 'apiSdk/message-templates';
...
function MessageTemplateViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('message_template', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/message-templates/edit/${data?.id}`} passHref legacyBehavior>
              <Button
